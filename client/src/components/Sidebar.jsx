...
export default function Sidebar({ filter, setFilter, stats }) {
  ...
  return (
    <aside className="w-[240px] bg-peach-100 border-r border-cream-200 flex flex-col h-screen fixed top-0 left-0">
      <div className="p-6">
        <h1 className="text-[20px] font-semibold text-peach-600 flex items-center gap-2">
